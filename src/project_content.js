...
const editProjectNameFormModal = document.querySelector(
  '#editProjectNameFormModal'
);
...
const editProjectNameCloseModalButton = document.querySelector(
  '#editProjectNameCloseModalButton'
);
const editTodoCloseModalButton = document.querySelector(
  '#editTodoCloseModalButton'
);
